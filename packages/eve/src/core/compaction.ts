import type { generateText, LanguageModel, ModelMessage } from "ai";
...
import type { CompactionConfig, GenerateConfig } from "#core/step-types.js";
...
export async function compactMessages(
  ...
  model: LanguageModel,
  config: CompactionConfig,
  generateSummary: CompactionTextGenerator,
...
/** Host-bound text generation used only after model-free compaction heuristics fail. */
export type CompactionTextGenerator = (input: {
