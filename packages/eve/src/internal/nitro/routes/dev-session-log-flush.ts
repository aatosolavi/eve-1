...
export async function handleDevSessionLogFlushRequest(request: Request): Promise<Response> {
  ...
  if (
    ...
    return Response.json({ error: "Session log flush request is not trusted." }, { status: 401 });
  }
