...
/**
 * Emits declarations for an extension's whole source tree. Uses the package's
 * TypeScript and authored `tsconfig.json` when present, otherwise eve-owned
 * defaults; any diagnostic that prevents a correct emit fails the build.
 */
